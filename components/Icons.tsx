...
export const CloudArrowUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75m-7.5 4.5V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.25 15.75V12.75c0-1.422-.832-2.65-2.012-3.143-1.1-2.25-3.41-3.6-5.988-3.6-2.72 0-5.082 1.5-6.237 3.69-1.3.36-2.263 1.5-2.263 2.813v2.531m16.5 0h-16.5" />
    </svg>
);
