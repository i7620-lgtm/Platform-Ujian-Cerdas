                    ...
                    <div className="relative">
                        ...
                        <div className="relative mt-1.5">
                            <input 
                                ...
                                className="w-full px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-indigo-200 focus:bg-white rounded-2xl outline-none text-sm font-bold text-slate-700 transition-all placeholder:text-slate-300 pr-12" 
                                required 
                                disabled={isLoading} 
                                placeholder="••••••••"
                            />
                    ...
                    {isRegistering && (
                        <div>
                            ...
                            <input 
                                ...
                                className={`w-full px-5 py-4 bg-slate-50 border-2 ${confirmPassword && password !== confirmPassword ? 'border-rose-200 bg-rose-50' : 'border-transparent'} focus:border-indigo-200 focus:bg-white rounded-2xl outline-none mt-1.5 text-sm font-bold text-slate-700 transition-all placeholder:text-slate-300`}
                                required 
                                disabled={isLoading} 
                                placeholder="••••••••"
                            />
