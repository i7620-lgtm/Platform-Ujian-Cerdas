  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-200 p-6 md:p-12 transition-colors duration-300">
      <div className="w-full max-w-full mx-auto animate-fade-in">
        <button
          onClick={onBack}
          className="group flex items-center gap-2 text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 mb-8 font-bold transition-all text-xs uppercase tracking-widest"
        >
        ...
        <div className="bg-white dark:bg-slate-900 p-8 md:p-12 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] dark:shadow-none border border-slate-100 dark:border-slate-800 relative overflow-hidden">
          ...
          <div className="prose prose-slate dark:prose-invert prose-sm max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-indigo-600 dark:prose-a:text-indigo-400">
            <p>
              Selamat datang di <strong>UjianCerdas</strong>. Dengan mengakses
              atau menggunakan layanan kami, Anda menyetujui untuk terikat oleh
              syarat dan ketentuan berikut:
            </p>

            <h3>1. Penggunaan Layanan</h3>
            <p>
              Platform ini dirancang untuk tujuan pendidikan dan evaluasi.
              Pengguna dilarang menyalahgunakan sistem untuk tindakan curang,
              ilegal, atau merugikan pihak lain. Anda setuju untuk menggunakan
              layanan ini sesuai dengan hukum yang berlaku.
            </p>

            <h3>2. Akun Pengguna</h3>
            <p>
              Anda bertanggung jawab untuk menjaga kerahasiaan kredensial akun
              Anda (email dan password). Segala aktivitas yang terjadi di bawah
              akun Anda adalah tanggung jawab Anda sepenuhnya. Harap segera
              laporkan jika ada penggunaan akun tanpa izin.
            </p>

            <h3>3. Konten & Hak Cipta</h3>
            <p>
              Soal, materi, dan data yang diunggah oleh guru tetap menjadi hak
              milik pembuatnya. Namun, dengan mengunggahnya, Anda memberikan
              lisensi kepada UjianCerdas untuk memproses, menyimpan, dan
              menampilkannya demi keperluan penyelenggaraan ujian.
            </p>

            <h3>4. Batasan Tanggung Jawab</h3>
            <p>
              UjianCerdas berupaya menyediakan layanan yang andal, namun kami
              tidak bertanggung jawab atas kerugian langsung maupun tidak
              langsung akibat penggunaan layanan, termasuk namun tidak terbatas
              pada kehilangan data, gangguan koneksi, atau kesalahan teknis saat
              ujian berlangsung.
            </p>
            ...
            <p>
              ...
              pemberitahuan sebelumnya. Pengguna disarankan untuk memeriksa
        ...
        <div className="bg-white dark:bg-slate-900 p-8 md:p-12 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] dark:shadow-none border border-slate-100 dark:border-slate-800 relative overflow-hidden">
          ...
          <div className="prose prose-slate dark:prose-invert prose-sm max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-emerald-600 dark:prose-a:text-emerald-400">
            <p>
              ...
              bagaimana <strong>UjianCerdas</strong> mengumpulkan, menggunakan,
            ...
            <p>
              ...
              mendaftar, seperti nama lengkap, alamat email, nama sekolah, dan
              kata sandi. Kami juga mengumpulkan data aktivitas penggunaan
              aplikasi, seperti log ujian, jawaban, dan nilai siswa.
            </p>
            ...
            <p>
              ...
              melindungi data Anda dari akses, penggunaan, atau pengungkapan
              yang tidak sah. Data sensitif seperti kata sandi disimpan
            ...
            <p>
              ...
              ketiga. Data Anda mungkin dibagikan hanya jika diwajibkan oleh
              hukum yang berlaku atau untuk keperluan operasional sekolah yang
              Anda otorisasi.
            </p>

            <h3>5. Cookie & Penyimpanan Lokal</h3>
            <p>
              Aplikasi ini menggunakan teknologi penyimpanan lokal (LocalStorage
              dan IndexedDB) pada perangkat Anda untuk memastikan fungsionalitas
              offline berjalan dengan baik dan untuk menyimpan preferensi
              pengguna.
            </p>
          </div>
