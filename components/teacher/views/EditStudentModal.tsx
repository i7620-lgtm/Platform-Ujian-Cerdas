...
import { useEditStudentModal } from "../useEditStudentModal";
...
export const EditStudentModal: React.FC<EditStudentModalProps> = ({
  ...
  const { formData, handleChange, handleSubmit } = useEditStudentModal({
    result,
    onSave,
  });
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-slide-in-up border border-white dark:border-slate-700 relative">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleChange("absentNumber", e.target.value)}
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              type="submit"
              className="flex-[2] py-3 text-xs font-bold text-white bg-blue-600 rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-200 dark:shadow-blue-900/30 transition-all uppercase tracking-wide flex items-center justify-center gap-2"
            >
