          ...
          <div className="px-6 pb-6 -mt-10 relative flex flex-col items-center text-center flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div className="bg-white p-2 rounded-xl border border-slate-100 shadow-sm mb-4 relative group shrink-0">
              ...
              <img
                src={qrUrl}
                alt="App QR"
                className="w-32 h-32 object-contain relative z-10 mix-blend-multiply dark:mix-blend-normal"
              />
            </div>

            <p className="text-[10px] text-slate-500 dark:text-slate-400 mb-4 leading-relaxed px-1">
              Pindai atau bagikan tautan ini untuk mengajak orang lain
      ...
      <div className="invitation-modal-root fixed inset-0 z-[150] flex items-center justify-center p-2 sm:p-6 bg-slate-900/70 backdrop-blur-md animate-fade-in font-sans overflow-hidden">
        ...
        <div className="print-container w-full h-full flex items-center justify-center pointer-events-none p-0 sm:p-4">
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-2 right-2 sm:top-4 sm:right-4 z-30 p-1.5 sm:p-2 bg-slate-100 dark:bg-slate-800 hover:bg-rose-500 hover:text-white text-slate-400 rounded-full transition-all no-print border border-transparent shadow-sm"
            >
            ...
            <div className="p-4 sm:p-6 md:p-8 flex flex-col items-center justify-center landscape:w-5/12 bg-slate-50/50 dark:bg-slate-800/30 border-b landscape:border-b-0 landscape:border-r border-slate-100 dark:border-slate-800 shrink-0 overflow-y-auto custom-scrollbar">
              <div className="flex items-center gap-2 mb-2 sm:mb-6 opacity-80">
                ...
                <span className="font-bold text-sm sm:text-base text-slate-700 dark:text-slate-300 tracking-tight">
                  UjianCerdas
                </span>
              </div>
              ...
              <div className="relative group scale-90 sm:scale-100 origin-center">
                ...
                <div className="relative bg-white p-2 sm:p-3 rounded-2xl sm:rounded-[1.5rem] shadow-xl border border-slate-100">
                  <img
                    src={qrUrl}
                    alt="Join QR"
                    className="w-24 h-24 sm:w-32 sm:h-32 landscape:w-40 landscape:h-40 object-contain"
                  />
                </div>
                <div className="mt-2 sm:mt-4 text-center">
                  <div className="inline-flex items-center gap-1.5 bg-white dark:bg-slate-800 px-2 sm:px-3 py-0.5 sm:py-1 rounded-full border border-slate-100 dark:border-slate-700 shadow-sm">
                    ...
                    <span className="text-[8px] sm:text-[10px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400">
                      Scan to Join
                    </span>
                  </div>
                </div>
            ...
            <div className="p-4 sm:p-6 md:p-8 flex flex-col landscape:w-7/12 relative bg-white dark:bg-slate-900 overflow-y-auto sm:overflow-visible">
              ...
              <div className="mb-2 sm:mb-4 pr-10">
                <span className="text-[8px] sm:text-[9px] font-black uppercase tracking-[0.15em] text-slate-400 dark:text-slate-500 mb-0.5 sm:mb-1 block">
                  Penyelenggara
                </span>
              ...
              <div className="mb-3 sm:mb-6 flex flex-col gap-1 sm:gap-2">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {exam && (
                    <span
                      className={`px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md sm:rounded-lg text-[8px] sm:text-[9px] font-black uppercase tracking-widest shadow-sm ${getExamTypeBadge(exam.config.examType)}`}
                    >
                  ...
                  {exam?.config.targetClasses &&
                    exam.config.targetClasses.map((c) => (
                      <span
                        key={c}
                        className="px-2 py-0.5 sm:px-2.5 sm:py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-[8px] sm:text-[9px] font-black rounded-md sm:rounded-lg border border-slate-200 dark:border-slate-700 uppercase tracking-tight"
                      >
                        {c}
                      </span>
                    ))}
              ...
              <div className="bg-slate-50 dark:bg-slate-800/40 rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-slate-100 dark:border-slate-700 mb-3 sm:mb-6 flex flex-col items-center text-center shadow-inner">
                {isStarted ? (
                  ...
                  <div className="w-full">
                    ...
                    <div className="grid grid-cols-4 gap-1.5 sm:gap-2 text-slate-800 dark:text-white">
                      {[
                        ...
                        <div
                          key={i}
                          className="flex flex-col items-center bg-white dark:bg-slate-800 rounded-lg sm:rounded-xl p-1.5 sm:p-2 border border-slate-100 dark:border-slate-700 shadow-sm"
                        >
                          <span className="font-code text-base sm:text-xl font-bold tabular-nums leading-none mb-0.5 sm:mb-1">
                            {t.val.toString().padStart(2, "0")}
                          </span>
                          <span className="text-[6px] sm:text-[7px] uppercase font-black text-slate-400">
                            {t.label}
                          </span>
                        </div>
                      ))}
                  ...
                  <div className="py-2 text-xs font-bold text-slate-400 animate-pulse tracking-widest uppercase">
                    Menyiapkan Waktu...
                  </div>
                )}
              </div>
