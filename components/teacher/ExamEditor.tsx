...
const WysiwygEditor: React.FC<{ 
    ...
    onAudioDelete?: () => void;
}> = ({ value, onChange, placeholder = "Ketik di sini...", minHeight = "120px", showTabs = true, audioUrl, onAudioUpload, onAudioDelete }) => {
                                        ...
                                        <div className="flex items-start gap-4 md:gap-6">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <WysiwygEditor 
                                                    ...
                                                    minHeight="80px"
                                                    audioUrl={q.audioUrl}
                                                    onAudioUpload={(e) => handleAudioUpload(q.id, e)}
                                                    onAudioDelete={() => handleDeleteAudio(q.id)}
                                                />
